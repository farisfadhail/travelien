        ...
        <div class="container max-w-screen-lg mx-auto">
            <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                    ...
                    <form class="lg:col-span-2" action="{{ route('user.order.store') }}" method="POST">
                        @csrf
                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                            ...
                            <div class="md:col-span-3">
                                ...
                                <input type="number" name="identity_number" id="identity_number" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{ old('identity_number')}}" placeholder="" />
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="number" name="phone" id="phone" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{ old('phone')}}" placeholder="" />
                                <span class="text-xs text-gray-600 dark:text-gray-400">
                            ...
                            <div class="md:col-span-3">
                                ...
                                <input type="date" name="date" id="date" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{ old('date')}}" placeholder="" />
                                @error('date')
                                    <small class="text-red-700">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="number" name="ticket_amount" id="amount" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{ old('ticket_amount')}}" placeholder="" />
                                @error('ticket_amount')
                                    <small class="text-red-700">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="md:col-span-2 md:mt-4 text-right">
                                <div class="inline-flex items-end">
                                    <a href="{{ route('spot.index') }}" class="font-bold py-2 px-4 rounded">Batal</a>
                                </div>
                                <div class="inline-flex items-end">
